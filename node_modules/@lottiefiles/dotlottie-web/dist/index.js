var x4=Object.defineProperty,j4=Object.defineProperties;var R4=Object.getOwnPropertyDescriptors;var N1=Object.getOwnPropertySymbols;var $3=Object.prototype.hasOwnProperty,W3=Object.prototype.propertyIsEnumerable;var _2=(v,i,a)=>i in v?x4(v,i,{enumerable:!0,configurable:!0,writable:!0,value:a}):v[i]=a,D=(v,i)=>{for(var a in i||(i={}))$3.call(i,a)&&_2(v,a,i[a]);if(N1)for(var a of N1(i))W3.call(i,a)&&_2(v,a,i[a]);return v},z=(v,i)=>j4(v,R4(i));var V1=(v,i)=>{var a={};for(var h in v)$3.call(v,h)&&i.indexOf(h)<0&&(a[h]=v[h]);if(v!=null&&N1)for(var h of N1(v))i.indexOf(h)<0&&W3.call(v,h)&&(a[h]=v[h]);return a};var b=(v,i,a)=>_2(v,typeof i!="symbol"?i+"":i,a);var E=(v,i,a)=>new Promise((h,d)=>{var y=R=>{try{j(a.next(R));}catch($){d($);}},T=R=>{try{j(a.throw(R));}catch($){d($);}},j=R=>R.done?h(R.value):Promise.resolve(R.value).then(y,T);j((a=a.apply(v,i)).next());});var g2=class{requestAnimationFrame(i){return requestAnimationFrame(i)}cancelAnimationFrame(i){cancelAnimationFrame(i);}},y2=class{constructor(){b(this,"_lastHandleId",0);b(this,"_lastImmediate",null);}requestAnimationFrame(i){return this._lastHandleId>=Number.MAX_SAFE_INTEGER&&(this._lastHandleId=0),this._lastHandleId+=1,this._lastImmediate=setImmediate(()=>{i(Date.now());}),this._lastHandleId}cancelAnimationFrame(i){this._lastImmediate&&clearImmediate(this._lastImmediate);}},q1=class{constructor(){b(this,"_strategy");this._strategy=typeof requestAnimationFrame=="function"?new g2:new y2;}requestAnimationFrame(i){return this._strategy.requestAnimationFrame(i)}cancelAnimationFrame(i){this._strategy.cancelAnimationFrame(i);}};var O=typeof window!="undefined"&&typeof window.document!="undefined";var J1=new Uint8Array([80,75,3,4]),z3=["v","ip","op","layers","fr","w","h"],w2="0.43.0",C2="@lottiefiles/dotlottie-web",U3=.75;var A4=(()=>{var i;var v=typeof document!="undefined"?(i=document.currentScript)==null?void 0:i.src:void 0;return function(a={}){var h,d=a,y,T,j=new Promise((t,e)=>{y=t,T=e;}),R=Object.assign({},d),$="./this.program",U="",l1;typeof document!="undefined"&&document.currentScript&&(U=document.currentScript.src),v&&(U=v),U.startsWith("blob:")?U="":U=U.substr(0,U.replace(/[?#].*/,"").lastIndexOf("/")+1),l1=t=>fetch(t,{credentials:"same-origin"}).then(e=>e.ok?e.arrayBuffer():Promise.reject(Error(e.status+" : "+e.url)));var T1=d.print||console.log.bind(console),K=d.printErr||console.error.bind(console);Object.assign(d,R),R=null,d.thisProgram&&($=d.thisProgram);var F1=d.wasmBinary,x1,j1=!1,K1,X,k,a1,f1,t1,F,S2,T2;function F2(){var t=x1.buffer;d.HEAP8=X=new Int8Array(t),d.HEAP16=a1=new Int16Array(t),d.HEAPU8=k=new Uint8Array(t),d.HEAPU16=f1=new Uint16Array(t),d.HEAP32=t1=new Int32Array(t),d.HEAPU32=F=new Uint32Array(t),d.HEAPF32=S2=new Float32Array(t),d.HEAPF64=T2=new Float64Array(t);}var x2=[],j2=[],R2=[];function K3(){var t=d.preRun.shift();x2.unshift(t);}var n1=0,p1=null;function R1(t){var e;throw (e=d.onAbort)==null||e.call(d,t),t="Aborted("+t+")",K(t),j1=!0,t=new WebAssembly.RuntimeError(t+". Build with -sASSERTIONS for more info."),T(t),t}var A2=t=>t.startsWith("data:application/octet-stream;base64,"),v1;function k2(t){if(t==v1&&F1)return new Uint8Array(F1);throw "both async and sync fetching of the wasm failed"}function X3(t){return F1?Promise.resolve().then(()=>k2(t)):l1(t).then(e=>new Uint8Array(e),()=>k2(t))}function D2(t,e,n){return X3(t).then(r=>WebAssembly.instantiate(r,e)).then(n,r=>{K(`failed to asynchronously prepare wasm: ${r}`),R1(r);})}function Z3(t,e){var n=v1;return F1||typeof WebAssembly.instantiateStreaming!="function"||A2(n)||typeof fetch!="function"?D2(n,t,e):fetch(n,{credentials:"same-origin"}).then(r=>WebAssembly.instantiateStreaming(r,t).then(e,function(o){return K(`wasm streaming compile failed: ${o}`),K("falling back to ArrayBuffer instantiation"),D2(n,t,e)}))}class O2{constructor(e){b(this,"name","ExitStatus");this.message=`Program terminated with exit(${e})`,this.status=e;}}var Z1=t=>{for(;0<t.length;)t.shift()(d);},Q1=d.noExitRuntime||!0,$2=typeof TextDecoder!="undefined"?new TextDecoder:void 0,m1=(t,e=0,n=NaN)=>{var r=e+n;for(n=e;t[n]&&!(n>=r);)++n;if(16<n-e&&t.buffer&&$2)return $2.decode(t.subarray(e,n));for(r="";e<n;){var o=t[e++];if(o&128){var s=t[e++]&63;if((o&224)==192)r+=String.fromCharCode((o&31)<<6|s);else {var u=t[e++]&63;o=(o&240)==224?(o&15)<<12|s<<6|u:(o&7)<<18|s<<12|u<<6|t[e++]&63,65536>o?r+=String.fromCharCode(o):(o-=65536,r+=String.fromCharCode(55296|o>>10,56320|o&1023));}}else r+=String.fromCharCode(o);}return r},W2=[],z2=0,s1=0;class e2{constructor(e){this.Fc=e,this.dc=e-24;}}var U2=t=>{var e=s1;if(!e)return P1(0),0;var n=new e2(e);F[n.dc+16>>2]=e;var r=F[n.dc+4>>2];if(!r)return P1(0),e;for(var o of t){if(o===0||o===r)break;if(u3(o,r,n.dc+16))return P1(o),e}return P1(r),e},_1=(t,e,n)=>{var r=k;if(0<n){n=e+n-1;for(var o=0;o<t.length;++o){var s=t.charCodeAt(o);if(55296<=s&&57343>=s){var u=t.charCodeAt(++o);s=65536+((s&1023)<<10)|u&1023;}if(127>=s){if(e>=n)break;r[e++]=s;}else {if(2047>=s){if(e+1>=n)break;r[e++]=192|s>>6;}else {if(65535>=s){if(e+2>=n)break;r[e++]=224|s>>12;}else {if(e+3>=n)break;r[e++]=240|s>>18,r[e++]=128|s>>12&63;}r[e++]=128|s>>6&63;}r[e++]=128|s&63;}}r[e]=0;}},i1=(t,e)=>Object.defineProperty(e,"name",{value:t}),t2=[],Z=[],M,Q3=t=>{throw new M(t)},c1=t=>{if(!t)throw new M("Cannot use deleted val. handle = "+t);return Z[t]},g1=t=>{switch(t){case void 0:return 2;case null:return 4;case!0:return 6;case!1:return 8;default:let e=t2.pop()||Z.length;return Z[e]=t,Z[e+1]=1,e}},B2=t=>{var e=Error,n=i1(t,function(r){this.name=t,this.message=r,r=Error(r).stack,r!==void 0&&(this.stack=this.toString()+`
`+r.replace(/^Error(:[^\n]*)?\n/,""));});return n.prototype=Object.create(e.prototype),n.prototype.constructor=n,n.prototype.toString=function(){return this.message===void 0?this.name:`${this.name}: ${this.message}`},n},H2,N2,A=t=>{for(var e="";k[t];)e+=N2[k[t++]];return e},y1={},n2=(t,e)=>{if(e===void 0)throw new M("ptr should not be undefined");for(;t.ic;)e=t.tc(e),t=t.ic;return e},r1={},V2=t=>{t=a3(t);var e=A(t);return Q(t),e},w1=(t,e)=>{var n=r1[t];if(n===void 0)throw t=`${e} has unknown type ${V2(t)}`,new M(t);return n},A1=()=>{},i2=!1,q2=(t,e,n)=>e===n?t:n.ic===void 0?null:(t=q2(t,e,n.ic),t===null?null:n.Ec(t)),J2={},e0=(t,e)=>(e=n2(t,e),y1[e]),C1,k1=(t,e)=>{if(!e.fc||!e.dc)throw new C1("makeClassHandle requires ptr and ptrType");if(!!e.lc!=!!e.jc)throw new C1("Both smartPtrType and smartPtr must be specified");return e.count={value:1},d1(Object.create(t,{cc:{value:e,writable:!0}}))},d1=t=>typeof FinalizationRegistry=="undefined"?(d1=e=>e,t):(i2=new FinalizationRegistry(e=>{e=e.cc,--e.count.value,e.count.value===0&&(e.jc?e.lc.nc(e.jc):e.fc.ec.nc(e.dc));}),d1=e=>{var n=e.cc;return n.jc&&i2.register(e,{cc:n},e),e},A1=e=>{i2.unregister(e);},d1(t)),D1={},r2=t=>{for(;t.length;){var e=t.pop();t.pop()(e);}};function b1(t){return this.fromWireType(F[t>>2])}var u1={},O1={},G=(t,e,n)=>{function r(c){if(c=n(c),c.length!==t.length)throw new C1("Mismatched type converter count");for(var l=0;l<t.length;++l)J(t[l],c[l]);}t.forEach(c=>O1[c]=e);var o=Array(e.length),s=[],u=0;e.forEach((c,l)=>{r1.hasOwnProperty(c)?o[l]=r1[c]:(s.push(c),u1.hasOwnProperty(c)||(u1[c]=[]),u1[c].push(()=>{o[l]=r1[c],++u,u===s.length&&r(o);}));}),s.length===0&&r(o);};function t0(t,e,n={}){var r=e.name;if(!t)throw new M(`type "${r}" must have a positive integer typeid pointer`);if(r1.hasOwnProperty(t)){if(n.Mc)return;throw new M(`Cannot register type '${r}' twice`)}r1[t]=e,delete O1[t],u1.hasOwnProperty(t)&&(e=u1[t],delete u1[t],e.forEach(o=>o()));}function J(t,e,n={}){return t0(t,e,n)}var o2=t=>{throw new M(t.cc.fc.ec.name+" instance already deleted")};function $1(){}var a2=(t,e,n)=>{if(t[e].hc===void 0){var r=t[e];t[e]=function(...o){if(!t[e].hc.hasOwnProperty(o.length))throw new M(`Function '${n}' called with an invalid number of arguments (${o.length}) - expects one of (${t[e].hc})!`);return t[e].hc[o.length].apply(this,o)},t[e].hc=[],t[e].hc[r.pc]=r;}},s2=(t,e,n)=>{if(d.hasOwnProperty(t)){if(n===void 0||d[t].hc!==void 0&&d[t].hc[n]!==void 0)throw new M(`Cannot register public name '${t}' twice`);if(a2(d,t,t),d[t].hc.hasOwnProperty(n))throw new M(`Cannot register multiple overloads of a function with the same number of arguments (${n})!`);d[t].hc[n]=e;}else d[t]=e,d[t].pc=n;},i0=t=>{t=t.replace(/[^a-zA-Z0-9_]/g,"$");var e=t.charCodeAt(0);return 48<=e&&57>=e?`_${t}`:t};function r0(t,e,n,r,o,s,u,c){this.name=t,this.constructor=e,this.oc=n,this.nc=r,this.ic=o,this.Hc=s,this.tc=u,this.Ec=c,this.Bc=[];}var c2=(t,e,n)=>{for(;e!==n;){if(!e.tc)throw new M(`Expected null or instance of ${n.name}, got an instance of ${e.name}`);t=e.tc(t),e=e.ic;}return t};function o0(t,e){if(e===null){if(this.xc)throw new M(`null is not a valid ${this.name}`);return 0}if(!e.cc)throw new M(`Cannot pass "${h2(e)}" as a ${this.name}`);if(!e.cc.dc)throw new M(`Cannot pass deleted object as a pointer of type ${this.name}`);return c2(e.cc.dc,e.cc.fc.ec,this.ec)}function a0(t,e){if(e===null){if(this.xc)throw new M(`null is not a valid ${this.name}`);if(this.wc){var n=this.yc();return t!==null&&t.push(this.nc,n),n}return 0}if(!e||!e.cc)throw new M(`Cannot pass "${h2(e)}" as a ${this.name}`);if(!e.cc.dc)throw new M(`Cannot pass deleted object as a pointer of type ${this.name}`);if(!this.vc&&e.cc.fc.vc)throw new M(`Cannot convert argument of type ${e.cc.lc?e.cc.lc.name:e.cc.fc.name} to parameter type ${this.name}`);if(n=c2(e.cc.dc,e.cc.fc.ec,this.ec),this.wc){if(e.cc.jc===void 0)throw new M("Passing raw pointer to smart pointer is illegal");switch(this.Tc){case 0:if(e.cc.lc===this)n=e.cc.jc;else throw new M(`Cannot convert argument of type ${e.cc.lc?e.cc.lc.name:e.cc.fc.name} to parameter type ${this.name}`);break;case 1:n=e.cc.jc;break;case 2:if(e.cc.lc===this)n=e.cc.jc;else {var r=e.clone();n=this.Pc(n,g1(()=>r.delete())),t!==null&&t.push(this.nc,n);}break;default:throw new M("Unsupporting sharing policy")}}return n}function s0(t,e){if(e===null){if(this.xc)throw new M(`null is not a valid ${this.name}`);return 0}if(!e.cc)throw new M(`Cannot pass "${h2(e)}" as a ${this.name}`);if(!e.cc.dc)throw new M(`Cannot pass deleted object as a pointer of type ${this.name}`);if(e.cc.fc.vc)throw new M(`Cannot convert argument of type ${e.cc.fc.name} to parameter type ${this.name}`);return c2(e.cc.dc,e.cc.fc.ec,this.ec)}function L1(t,e,n,r,o,s,u,c,l,f,p){this.name=t,this.ec=e,this.xc=n,this.vc=r,this.wc=o,this.Oc=s,this.Tc=u,this.Cc=c,this.yc=l,this.Pc=f,this.nc=p,o||e.ic!==void 0?this.toWireType=a0:(this.toWireType=r?o0:s0,this.kc=null);}var G2=(t,e,n)=>{if(!d.hasOwnProperty(t))throw new C1("Replacing nonexistent public symbol");d[t].hc!==void 0&&n!==void 0?d[t].hc[n]=e:(d[t]=e,d[t].pc=n);},P,c0=(t,e,n=[])=>(t.includes("j")?(t=t.replace(/p/g,"i"),e=(0, d["dynCall_"+t])(e,...n)):e=P.get(e)(...n),e),d0=(t,e)=>(...n)=>c0(t,e,n),W=(t,e)=>{t=A(t);var n=t.includes("j")?d0(t,e):P.get(e);if(typeof n!="function")throw new M(`unknown function pointer with signature ${t}: ${e}`);return n},Y2,M1=(t,e)=>{function n(s){o[s]||r1[s]||(O1[s]?O1[s].forEach(n):(r.push(s),o[s]=!0));}var r=[],o={};throw e.forEach(n),new Y2(`${t}: `+r.map(V2).join([", "]))};function K2(t){for(var e=1;e<t.length;++e)if(t[e]!==null&&t[e].kc===void 0)return !0;return !1}function X2(t){var e=Function;if(!(e instanceof Function))throw new TypeError(`new_ called with constructor type ${typeof e} which is not a function`);var n=i1(e.name||"unknownFunctionName",function(){});return n.prototype=e.prototype,n=new n,t=e.apply(n,t),t instanceof Object?t:n}function W1(t,e,n,r,o,s){var u=e.length;if(2>u)throw new M("argTypes array size mismatch! Must at least get return value and 'this' types!");var c=e[1]!==null&&n!==null,l=K2(e);for(n=e[0].name!=="void",r=[t,Q3,r,o,r2,e[0],e[1]],o=0;o<u-2;++o)r.push(e[o+2]);if(!l)for(o=c?1:2;o<e.length;++o)e[o].kc!==null&&r.push(e[o].kc);l=K2(e),o=e.length-2;var f=[],p=["fn"];for(c&&p.push("thisWired"),u=0;u<o;++u)f.push(`arg${u}`),p.push(`arg${u}Wired`);f=f.join(","),p=p.join(","),f=`return function (${f}) {
`,l&&(f+=`var destructors = [];
